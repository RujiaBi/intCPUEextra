---
title: "Getting started with intCPUEextra"
output:
  rmarkdown::html_vignette:
    toc: true
    toc_depth: 2
vignette: >
  %\VignetteIndexEntry{Getting started with intCPUEextra}
...
**intCPUEextra** is a multi-area extension of **intCPUE**.

Its main design is simple:
...
- temporal effects and latent population structure are area-specific
- flag-specific spatial deviations use a dedicated full-domain mesh

This package is intended for joint multi-area CPUE standardization when
vessel behavior, fishery effects, and flag-time effects are expected to
be comparable across areas, while temporal effects and latent
population structure remain area-specific.

The model keeps the same broad workflow as **intCPUE**:

- project coordinates with `make_utm()`
